...
sentences = Sentence.create( english_sentence: "I'm an office worker." )
...
sentences = Sentence.create( english_sentence: "I speak a little of your language" )
...
sentences = Sentence.create( english_sentence: "It's on the left (right) (straight ahead) (at the corner)." )
...
sentences = Sentence.create( english_sentence: "Where is the embassy (consulate)?" )
